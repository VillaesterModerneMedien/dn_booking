...
?>
<div class="dnbooking dnbooking_room">
	<form action="<?php echo Route::_('index.php?option=com_dnbooking&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
        ...
        <div class="main-card">
            ...
            <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'details', empty($this->item->id) ? Text::_('COM_DNBOOKING_NEW_ROOM') : Text::_('COM_DNBOOKING_EDIT_ROOM')); ?>
            <div class="row">
                <div class="col-lg-9">
                    <?php echo $this->form->renderFieldset('roomfieldset'); ?>
                </div>
                <div class="col-lg-3">
