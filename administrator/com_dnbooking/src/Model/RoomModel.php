...
class RoomModel extends AdminModel
{
	 ...
	 * @since    1.0.0
	 */
	public $typeAlias = 'com_dnbooking.room';
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_dnbooking.edit.room.data', array());

		if (empty($data))
		{
			$data = $this->getItem();
		}
		$this->preprocessData($this->typeAlias, $data, 'room');
	...
	protected function canEditState($record)
	{
		...
		if (!empty($record->id))
		{
            return Factory::getApplication()->getIdentity()->authorise('core.edit.state', 'com_dnbooking.room.' . (int) $record->id);
		}
