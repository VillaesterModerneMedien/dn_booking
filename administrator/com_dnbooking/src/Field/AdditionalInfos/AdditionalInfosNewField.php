...
namespace DnbookingNamespace\Component\Dnbooking\Administrator\Field\AdditionalInfosNew;
 ...
 * @since  3.6
 */
class AdditionalInfosNewField extends FormField
{
	/**
	 * The form field type.
	 * @var    string
	 */
	protected $type = 'AdditionalInfosNew';
